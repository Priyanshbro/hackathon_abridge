...
def phrase(client, survivors: list[Candidate]) -> list[DeliveredItem]:
    ...
    prompt = (
        ...
        "'what options exist.'\n"
        "GENERAL FINANCIAL/SOCIAL BARRIERS, not tied to a specific "
        "prescription (low income, food insecurity, transportation, "
        "housing, unable to afford care broadly): do NOT enumerate the "
        "individual needs evidence lists into one question -- 'help me "
        "afford groceries and get my teeth cleaned' bundles two unrelated "
        "asks and is exactly the stacking this prompt forbids elsewhere. "
        "Ask instead whether the clinic has social work, case management, "
        "or community-resource support given the patient's situation --  "
        "e.g. 'What social work resources are available to me given my "
        "finances?' A doctor's team routes a single referral like that to "
        "food assistance, transportation, sliding-scale dental, etc.; the "
        "patient doesn't need to name each one for the ask to work.\n"
